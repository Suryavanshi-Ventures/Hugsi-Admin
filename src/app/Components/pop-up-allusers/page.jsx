      ...
      <div className="w-[800px] max-h-[80vh] overflow-hidden bg-white rounded-lg flex flex-col">
        <div className="bg-[#FFBF00] w-full columns-2 flex justify-end p-6 rounded-t">
          <div className="float-right pr-10">
            <h3 className="text-white text-md font-bold text-xl">My Profile</h3>
          </div>
          ...
          <div>
            <div className="row cloumns-2 flex justify-between pb-2.5">
              <div className="col">
                <h4>
                  Full Name:{" "}
                  <span className="text-[#767676]">{users?.name || "N/A"}</span>
                </h4>
              </div>
              <div className="col">
                <h4 className="pr-4">
                  Email:{" "}
                  <span className="text-[#767676]">{users?.email || "N/A"}</span>
                </h4>
              </div>
            </div>
            ...
            <div className="row cloumns-2 flex justify-between py-2.5">
              <div className="col">
                <h4>
                  Phone Number:{" "}
                  <span className="text-[#767676]">{users?.phone || "N/A"}</span>
                </h4>
              </div>
              <div className="col">
                <h4 className="pr-4">
                  DOB:{" "}
                  <span className="text-[#767676]">{users?.dob || "N/A"}</span>
                </h4>
              </div>
            </div>
            <hr className="text-[#D9D9D9] border-[1px]" />
            ...
            <div className="row cloumns-2 flex justify-between py-2.5">
              <div className="col">
                <h4>
                  Connections :{" "}
                  <span className="text-[#767676]"> {users?.connections}</span>
                </h4>
              </div>
              <div className="col">
                <h4 className="pr-4">
                  Gift Search: <span className="text-[#767676]">{users?.gift_search || "N/A"}</span>
                </h4>
              </div>
            </div>
            <hr className="text-[#D9D9D9] border-[1px]" />
      ...
      <p key={key}>
        {key}: {value}%,{" "}
            ...
            <div className="row cloumns-2 flex flex-col py-2.5">
              ...
              <div>
  {users?.psych_ans && users?.psych_ans.map((data, index) => (
    <div key={index}>
      <h4>Q. {data.que}</h4>
      <h4 className="text-[#767676]">A. {data.ans}</h4>
            ...
            <div className="col">
  <h4>
    Interests: <span className="text-[#767676]"> {users?.interest && users?.interest.map((data, index) => data).join(", ")}</span>
  </h4>
</div>
            ...
            <div className="row cloumns-2 flex flex-col justify-between py-2.5">
              ...
              {users?.wishlist && users?.wishlist.map((data, index) => 
              <div key={index}>
              <div className="row columns-2">
                <div className="col">
                  <h4>
                    Name: <span className="text-[#767676]">{data.name}
</span>
                  </h4>
                </div>
          ...
          "N/A"
              ...
              <div className="col">
                <h4>
                  Price : <span className="text-[#767676]">{data.price}</span>
                </h4>
              </div>
              </div>)}
            </div>  
            ...
            <div className="row cloumns-2 flex flex-col justify-between pt-2.5">
              ...
              <div className="row columns-3">
                <div className="col">
                  <h4>Gift Language: {users?.strength?.items?.gift_lan ?? 0}%,</h4>
                </div>

                <div className="col">
                  <h4>Interest: {users?.strength?.items?.interest}%,</h4>
                  <h4>Profile Pic: {users?.strength?.items?.profile_pic ?? 0}%,</h4>
                </div>
              </div>

              <div className="row columns-2">
                <div className="col">
                  <h4>Physiological Answer: {users?.strength?.items?.psych_ans ?? 0}%,</h4>
                </div>

                <div className="col">
                  <h4>Wishlist: {users?.strength?.items?.wishlist ?? 0}%</h4>
                </div>
              </div>
              </div>
            </div>
